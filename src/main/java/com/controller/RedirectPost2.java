...
public class RedirectPost2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().print("<h3>We are in the doGet method of second servlet"
				+"college name "+name+"</h3>");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String name= request.getParameter("college");
		response.setContentType("text/html");
		response.getWriter().print("<h3>We are in the doPost method of second servlet "
				+"college name "+name+"</h3>");
	}
